// DO NOT EDIT. Generated with goinline -package=github.com/sasha-s/go-inline/examples/blueprints/search --target-package-name=s -target-dir=. -w Element->string
...
func (data Data) Search(x string,) int {
	// f(i) == data[i] >= x
...
// If there is no such index, Search returns n.
func (data Data) ReverseSearch(x string,) int {
	// f(i) == data[i] <= x
	// Define f(-1) == false and f(n) == true.
	// Invariant: f(i-1) == false, f(j) == true.
	i, j := 0, len(data)
